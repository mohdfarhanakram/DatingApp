...
public class SimpleFacebook {
     ...
     *
     * @param configuration The configuration of this library
     */
     ...
     * General GET method.
     *
     * @param entityId         The id of the entity you want to retrieve.
     * @param edge             The graph edge. Like "friends", "groups" ...
     * @param onActionListener The listener with the type you expect as response.
     */
     ...
     *
     * @param onAlbumsListener The callback listener
     */
     ...
     *
     * @param entityId         profile id or page id.
     * @param onAlbumsListener The callback listener.
     */
     ...
     *
     * @param onAppRequestsListener The callback listener.
     */
     ...
     *
     * @param entityId           Album, Checkin, Comment, Link, Photo, Post or Video.
     * @param onCommentsListener The callback listener.
     */
     ...
     *
     * @param eventDecision    The type of event: attending, maybe, declined.
     * @param onEventsListener The callback listener.
     */
     ...
     * {@link Permission#FRIENDS_EVENTS}
     *
     * @param entityId         Profile, Page or Group.
     * @param eventDesicion    The type of event: attending, maybe, declined.
     * @param onEventsListener The callback listener.
     */
     ...
     * <br>
     *
     * @param onFriendsListener The callback listener.
     */
     ...
     *
     * @param onGroupsListener The callback listener.
     */
     ...
     * Get page by page id.
     *
     * @param entityId       The page id.
     * @param onPageListener The callback listener.
     */
     ...
     *
     * @param entityId       The page id.
     * @param properties     Properties you want to get.
     * @param onPageListener The callback listener.
     */
     ...
     * {@link Permission#USER_PHOTOS}
     *
     * @param onPhotosListener The callback listener.
     */
     ...
     * {@link Permission#FRIENDS_PHOTOS}
     *
     * @param entityId         Album, Event, Page, Profile
     * @param onPhotosListener The callback listener.
     */
     ...
     *
     * @param onProfileListener The callback listener.
     */
     ...
     *
     * @param onPostsListener The callback listener.
     */
     ...
     * {@link Permission#READ_STREAM}
     *
     * @param entityId        Event, Group, Page, Profile
     * @param onPostsListener The callback listener.
     */
     ...
     *
     * @param entityId        Event, Group, Page, Profile
     * @param postType        Filter all wall feeds and get posts that you need.
     * @param onPostsListener The callback listener.
     */
     ...
     * <br>
     *
     * @param onScoresListener The callback listener.
     ...
     *
     * @param onVideosListener The callback listener.
     */
     ...
     *
     * @param entityId         Profile, Page, Event
     * @param onVideosListener The callback listener.
     */
     ...
     * {@link Permission#PUBLISH_ACTION}
     *
     * @param feed              The feed to publish. Use {@link Feed.Builder} to create a new
     *                          <code>Feed</code>
     ...
     *
     * @param message          (Optional) The message inside the dialog. It could be
     *                         <code>null</code>
     * @param data             (Optional) The data you want to send within the request. It
     ...
     * <br>
     *
     * @param inRequestId      Input request id to be deleted. Note that it should have the
     *                         form {USERID}_{REQUESTID} <code>String</code>
     * @param onDeleteListener The listener for deletion action
     * @see https
     ...
     *
     * @param permissions              New permissions you want to have. This array can include READ
     *                                 and PUBLISH permissions in the same time. Just ask what you
     *                                 need.<br>
     *                                 <br>
     * @param showPublish              This flag is relevant only in cases when new permissions
     ...
     *                                 action.<br>
     *                                 <br>
     * @param onNewPermissionsListener The listener for the requesting new permission action.
     */
