...
public class Switch extends CompoundButton
{
	...
	private Layout makeLayout(CharSequence text)
	{
		...
		Layout layout = new StaticLayout(transformed, mTextPaint, (int) FloatMath.ceil(Layout.getDesiredWidth(transformed, mTextPaint)), Layout.Alignment.ALIGN_NORMAL, 1.f, 0, true);
