...
public class ImageViewUtil {
 ...
 // Scale the image down for faster face detection.
    public static Bitmap prepareBitmapFromMatrix(Bitmap original,Matrix matrix) {
        if (original == null) {
            return null;
        }

        Bitmap faceBitmap = Bitmap.createBitmap(original, 0, 0, original.getWidth(), original.getHeight(), matrix, true);
        return faceBitmap;
    }
}
